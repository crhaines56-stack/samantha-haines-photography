...
export const metadata: Metadata = {
  title: "Lakeway Photographer | Samantha Haines Photography | Austin, TX",
  description:
    "Portrait photographer serving Lakeway, TX. Specializing in boudoir, family, senior, newborn, maternity & headshots. Hair & makeup always included. Book today.",
  alternates: {
    canonical: "https://www.samanthahainesphotography.com/lakeway-photographer",
  },
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "Do you photograph families in Lakeway?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes. Lakeway is one of Samantha's favorite communities to serve. The lakeside setting and natural beauty of the area make for stunning backdrops, and the families here bring such warmth to every session.",
      },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Every session includes professional hair and makeup, a pre-shoot consultation, expert posing direction, and white-glove wall art installation assistance. Everything you need for an exceptional portrait experience is included.",
      },
    },
    {
      "@type": "Question",
      name: "Do you travel to Lakeway for outdoor sessions?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Absolutely. Lakeway's lakeside parks and scenic outdoor areas are beautiful for portrait sessions. Samantha loves incorporating natural settings, and Lakeway has no shortage of them.",
      },
    },
    {
      "@type": "Question",
      name: "What types of photography do you offer in Lakeway?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Samantha offers boudoir, family, senior portraits, newborn, maternity, and professional headshots & branding for Lakeway clients. Every session includes professional hair and makeup.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Visit samanthahainesphotography.com/contact and fill out the form. Samantha will reach out to schedule your consultation and begin crafting your session from there.",
      },
    },
  ],
};
...
const services = [
  { href: "/boudoir-photographer-austin", title: "Boudoir", desc: "Intimate, empowering portraits celebrating who you are right now.", img: "https://res.cloudinary.com/du67vy39a/image/upload/v1784506563/shp/homepage/shp/homepage/service-boudoir.jpg" },
  ...
  { href: "/newborn-photographer-austin", title: "Newborn", desc: "Tiny details and pure wonder. captured in the first days of life.", img: "https://res.cloudinary.com/du67vy39a/image/upload/v1784506229/shp/newborn/shp/newborn/hero.jpg" },
  { href: "/maternity-photographer-austin", title: "Maternity", desc: "Powerful, beautiful portraits honoring this remarkable chapter.", img: "https://res.cloudinary.com/du67vy39a/image/upload/v1784506229/shp/newborn/shp/newborn/hero.jpg" },
        ...
        <div style={{height: '300vh'}}>
          ...
          <div className="absolute inset-0 bg-[#1a1a1a]">
            <Image
              ...
              alt="Lakeway Photographer. Samantha Haines Photography"
              fill
              priority
              ...
              {services.map((s) => (
                <Link key={s.href} href={s.href} className="group block bg-[#faf9f7] overflow-hidden hover:shadow-lg transition-shadow duration-300">
                  <div className="relative h-56 overflow-hidden">
                    <Image src={s.img} alt={`${s.title} photographer Lakeway Austin TX`} fill className="object-cover group-hover:scale-105 transition-transform duration-700" />
                  </div>
                  <div className="p-6">
        ...
        <section className="py-24 px-6 bg-[#1a1a1a] text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <h2 className="font-serif text-5xl md:text-6xl text-[#faf9f7] mb-8 leading-tight italic">
              Lakeway&rsquo;s finest portraits begin with a conversation.
            </h2>
            <p className="font-sans text-[14px] text-[#6b6b6b] leading-relaxed mb-10">
              Tell Samantha who you are and what you envision. Together you&rsquo;ll create portraits worth keeping.
            </p>
