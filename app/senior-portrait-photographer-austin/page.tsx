        ...
        <section className="py-24 px-6 bg-[#f5f0ea]">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mt-6">
              <Link href="/gallery/senior" className="font-sans text-[12px] tracking-[0.2em] uppercase text-[#8b6f5e] hover:text-[#1a1a1a] transition-colors border-b border-[#8b6f5e] pb-0.5">
                See Full Portfolio →
              </Link>
            </div>
          </div>
