...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Samantha photographs at Vue Studio, a private luxury studio in Northwest Austin — just a short drive from Westlake. Exact address and parking details are shared when you book.",
      },
    },
    {
      "@type": "Question",
